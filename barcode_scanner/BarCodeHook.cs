...
public delegate void BarCodeDelegate(BarCodes barCode);  
           ...
           {  
               ...
               {  
                   ...
                   {  
                       ...
                       if ((msg.message & 0xff) == 9 && strBarCode.Length > 3)   //Tab结束 并且 接收到的数个数大于3
                       {  
       ...
       private static HookProc mhookproc;
        // 安装钩子    
        public bool Start()  
        {
            mhookproc = new HookProc(KeyboardHookProc);
            ...
            {  
                ...
                hKeyboardHook = SetWindowsHookEx(13, mhookproc, Marshal.GetHINSTANCE(Assembly.GetExecutingAssembly().GetModules()[0]), 0);  
                //长城修改
            }  
